"""IMASPy-based command line tool for analysing fields in a database."""
...
@click.option(
    ...
    "-o",
    type=outfile_path,
    default="imaspy-db-analysis.json.gz",
    help="Output file",
)
def analyze_db(dbentry: Iterable[Path], output: Path) -> None:
    ...
    3. If your data is stored in another format than HDF5, you may use `imaspy convert`
